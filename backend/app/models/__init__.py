...
class District(db.Model):
    ...
    province_id = db.Column(
        db.Integer,
        db.ForeignKey('provinces.province_id'),
        nullable=False)
...
class ExamPaper(db.Model):
    ...
    subject_id = db.Column(
        ...
        db.ForeignKey('subjects.subject_id'),
        nullable=False)
    exam_session_id = db.Column(db.Integer,
                                db.ForeignKey('exam_sessions.exam_session_id'))
...
class Question(db.Model):
    ...
    paper_id = db.Column(
        db.Integer,
        db.ForeignKey('exam_papers.paper_id'),
        nullable=False)
...
class AnswerChoice(db.Model):
    ...
    media_id = db.Column(db.Integer, db.ForeignKey(
        'question_media.media_id'), nullable=True)
...
class ExamAttempt(db.Model):
    ...
    schedule_id = db.Column(db.Integer, db.ForeignKey(
        'exam_schedules.schedule_id'), nullable=False)
...
class StudentResponse(db.Model):
    ...
    attempt_id = db.Column(db.Integer, db.ForeignKey(
        'exam_attempts.attempt_id'), nullable=False)
    question_id = db.Column(
        db.Integer,
        db.ForeignKey('questions.question_id'),
        nullable=False)
...
class QuestionSection(db.Model):
    ...
    paper_id = db.Column(
        ...
        db.ForeignKey('exam_papers.paper_id'),
        nullable=False)
    section_type_id = db.Column(db.Integer, db.ForeignKey(
        'question_section_types.section_type_id'), nullable=True)
