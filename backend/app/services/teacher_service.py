...
class TeacherService:
    ...
    @staticmethod
    def create_student_account(cccd, full_name, gender, date_of_birth, address, phone, 
                               class_name, school_id, teacher_user_id, permanent_address=None):
    ...
    @staticmethod
    def bulk_register_students(student_ids, subject_ids, exam_session_id, teacher_user_id):
        ...
        try:
            ...
            for student_id in student_ids:
                ...
                if not student or student.school_id != teacher.school_id:
                    errors.append({'student_id': student_id, 'error': 'Invalid student'})
                    continue
    ...
    @staticmethod
    def submit_makeup_request(student_ids, subject_id, exam_session_id, teacher_user_id):
    ...
    def import_students_batch(students_data, school_id, teacher_user_id):
        ...
        try:
            ...
            for row_num, row in enumerate(students_data, start=2):
                is_valid, field_errors = StudentImportService.validate_student_row(row, required_fields)
