...
def audit_log(action, target_table=None, target_id=None, old_values=None, new_values=None):
...
def login():
    ...
    try:
        ...
        if user.role == 'teacher':
            ...
            user_data['teacher_type'] = teacher_rec.subject_specialty if teacher_rec else 'GVQL'
...
def setup_2fa():
    ...
    try:
        ...
        provisioning_uri = totp.provisioning_uri(
            ...
            issuer_name='THPT QG Exam System'
        )
